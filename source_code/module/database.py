...
class Database:
    ...
    def insert(self, data):
        ...
        try:
            ...
            cursor.execute("INSERT INTO phone_book(id,name,gender,salary,address, performance_score,remarks) VALUES( %s, %s, %s, %s, %s, %s, %s)",
    ...
    def update(self, id, data):
        ...
        try:
            cursor.execute("UPDATE phone_book set name = %s, gender = %s, salary = %s, address = %s, performance_score = %s, remarks =%s where id = %s",
